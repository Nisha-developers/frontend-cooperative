...
const DashboaHeader = ({ mobileMenuOpen, setMobileMenuOpen }) => {
  return (
      ...
      <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
        ...
        <button className="flex items-center gap-3 p-2 hover:bg-[#FDF6EC] rounded-xl transition-all duration-300 group">
          ...
          <div className="hidden md:block text-left">
            <p className="text-sm font-medium text-[#003000]">Adenola Aishat</p>
            <p className="text-xs text-[#2E7D32]">aishatadebukola@gmail.com</p>
          </div>
        </button>
      </div>
    </div>
